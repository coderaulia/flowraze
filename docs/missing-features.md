...
- **Sales targets**: Backend models, seed data, `/api/targets`, `/api/targets/teams`, and `/api/dashboard/targets` exist. The `/targets` page displays achievement KPIs, category mix, monthly breakdowns, leaderboards, target create/edit/delete controls, and superadmin sales-team setup.
